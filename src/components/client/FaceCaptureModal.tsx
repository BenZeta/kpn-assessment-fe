    ...
    >
      <DialogTitle sx={{ textAlign: "center", pb: 1 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Please take a clear photo of your face for verification purposes. This photo will be used
      ...
      >
        ...
        <Typography variant="caption" color="text.secondary" textAlign="center">
          Make sure your face is clearly visible and well-lit before capturing. This modal cannot be
          closed until a photo is taken.
        </Typography>
      </DialogContent>
    </Dialog>
  );
