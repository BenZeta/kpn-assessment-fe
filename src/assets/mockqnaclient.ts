const Mock = {
  ...
  questions: [
    {
      question_id: "0660eab0-738e-43b4-a617-cd282beb3f16",
      input: {
        text: "Andi membeli boneka seharga Rp50.000. Setelah itu, boneka dijual lagi dengan harga Rp80.000. Berapa persen keuntungan Andi?",
        image_url: null,
      },
      answer_type: "single",
      choices: {
    ...
    {
      question_id: "4c06c409-f849-4493-b748-e38f3b0b691f",
      input: {
        text: "Sebuah pesawat terbang berangkat dari Kota Kupang menuju Kota Jakart pukul 07.00 dan perjalanan ke Jakarta selama 4 jam. Transit di Denpasar selama 30 menit. Pukul berapa pesawat tersebut tiba di Jakarta?",
        image_url: null,
      },
      answer_type: "single",
      choices: {
    ...
    },
    {
      ...
      input: {
        text: "Doni memiliki uang Rp45.000.000 dan ia berniat untuk membeli saham kamera seharga Rp2.500.000 sebelum diskon. Harga diskon kamera tersebut adalah 20%. Selain itu, Doni juga membelanjakan uangnya untuk keperluan lain sebesar Rp1.500.000. Berapa sisa uang Doni saat ini?",
        image_url: null,
      },
      answer_type: "single",
      choices: {
